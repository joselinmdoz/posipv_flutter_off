...
class WorkOrderTaskWorkerRoleCard extends StatelessWidget {
  const WorkOrderTaskWorkerRoleCard({
    super.key,
    required this.role,
  ...
  final WorkOrderTaskWorkerRoleModel role;
  final VoidCallback onEdit;
  final ValueChanged<bool> onToggleActive;

  @override
  Widget build(BuildContext context) {
    final bool isActive = role.isActive;
    final Color accent =
