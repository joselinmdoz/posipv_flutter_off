...
class LicenseStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!hasExpiry || expired) {
      progress = expired ? 1 : 0; // if infinite, no progress. if expired, full progress consumed.
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: license.isActive
                            ...
                            : (isDark ? const Color(0xFFDC2626).withValues(alpha: 0.3) : const Color(0xFFFEE2E2)),
                ...
                if (hasExpiry) ...[
                  ...
                  Container(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width * progress, // Appears as full-width proportional to screen, sufficient for UI
                        decoration: BoxDecoration(
